...
class Database {
	...
	async postAuditoriums(data) {
		...
		return await connection
			...
			.query(
				"INSERT AUDITORIUM(AUDITORIUM, AUDITORIUM_NAME, AUDITORIUM_TYPE, AUDITORIUM_CAPACITY) OUTPUT INSERTED.* VALUES(@auditorium, @auditorium_name, @auditorium_type, @auditorium_capacity)"
			);
	}
	...
	async putAuditoriums(data) {
		...
		return await connection
			...
			.input("AUDITORIUM_CAPACITY", sql.Int, auditorium_capacity)
			.query(
				"UPDATE AUDITORIUM SET AUDITORIUM_NAME = @auditorium_name, AUDITORIUM_TYPE = @auditorium_type, AUDITORIUM_CAPACITY = @auditorium_capacity OUTPUT INSERTED.* WHERE AUDITORIUM = @auditorium"
			);
	}
	...
	async deleteAuditoriums(code) {
		...
		return await connection
			...
			.input("AUDITORIUM", sql.NVarChar, auditorium)
			.query(
				"DELETE FROM AUDITORIUM  OUTPUT DELETED.* WHERE AUDITORIUM = @auditorium "
			);
	}
	...
	async deleteAuditoriumsTypes(code) {
		...
		return await connection
			...
			.input("AUDITORIUM_TYPE", sql.NVarChar, auditorium_type)
			.query(
				"DELETE FROM AUDITORIUM_TYPE  OUTPUT DELETED.*  WHERE AUDITORIUM_TYPE = @auditorium_type"
			);
	}
}
